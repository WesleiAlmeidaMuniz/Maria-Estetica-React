...
export const Header = () => {
  ...
  return (
    <div className="bg-[#FFEBCD]">
      <header className="w-full h-30 md:h-[100px] relative flex justify-around items-center max-md:flex-col max-md:py-5" >
        <div>
          <img
            src="/images/logo.png"
            alt="Logotipo Estetica"
        ...
        <div>
          <a href="https://wa.me/5511946101374?text=Olá Maria Silva, tudo bem? gostaria de um orçamento, por favor."
            target="_blank" rel="noreferrer">
            <button className="flex px-2 py-2 border-[1px] rounded-lg border-gray-500 text-gray-500 items-center hover:text-white hover:border-white hover:bg-[#f84301] transition" type="button">CONTATO
              <svg  className="mx-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                viewBox="0 0 16 16">
                <path 
